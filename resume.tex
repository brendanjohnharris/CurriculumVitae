...
\begin{minipage}[t]{0.43\textwidth}
    ...
    \contactrow{\contact{\fascholar}{\href{https://scholar.google.com/citations?user=XYfQ92sAAAAJ}{Google Scholar}}}{\contact{\fabluesky}{\href{https://bsky.app/profile/brendanjohnharris.bsky.social}{brendanjohnharris.bsky.social}}}
    \contactrow{\contact{\fafile}{\href{https://brendanjohnharris.github.io/cv/}{Full CV}}}{}
\end{minipage}
...
I study the principles of neural computation using statistical physics, dynamical systems, new analytical methods, and large-scale data:\\[3pt]
...
\hspace*{1.5em}\textbullet\ \ \textbf{Criticality}: noise-robust methods to track the distance to criticality in noisy, poorly sampled systems.\\[1pt]
