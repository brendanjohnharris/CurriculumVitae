...
I study the principles of neural computation using large-scale data, new analytical methods, statistical physics, and dynamical systems:\\[3pt]
\hspace*{1.5em}\textbullet\ \ \textbf{Spatiotemporal dynamics}: how nested traveling waves coordinate hierarchical neural processing and guide flexible behavior.\\[1pt]
\hspace*{1.5em}\textbullet\ \ \textbf{Criticality}: robust methods to track the distance to criticality in noisy, poorly sampled systems.\\[1pt]
\hspace*{1.5em}\textbullet\ \ \textbf{Stochastic processes}: fractional mean-field theory for neural circuits, fractional diffusion for decision-making and visual sampling.\\[1pt]
\hspace*{1.5em}\textbullet\ \ \textbf{Population geometry}: low-dimensional coding and communication subspaces, new methods for dimensionality reduction.
...
\noindent\begin{minipage}[t]{\textwidth}\small
\href{https://scholar.google.com/citations?user=XYfQ92sAAAAJ}{6 peer-reviewed publications}, 73 citations, h-index 5. 2 first-author papers in Q1 journals (\href{https://doi.org/10.1103/PhysRevX.14.031021}{\emph{Physical Review X}}, top 3\% General Physics and Astronomy, Scopus CiteScore; \href{https://doi.org/10.1038/s41467-026-68893-4}{\emph{Nature Communications}}, top 3\% Multidisciplinary). All first-author work accompanied by \href{https://github.com/brendanjohnharris}{open-source code}.
\end{minipage}\par\vspace{2pt}
...
\entrydesc{2026--}{Primary supervisor, Physics undergraduate group project}{The University of Sydney}{}\vspace{-1.4em}
...
\hspace*{1.5em}\textbullet\ Aiden Sloots (2025) --- \emph{Bi-fractional diffusion for decision-making dynamics}}\vspace{-0.4em}
\entrydesc{2022--2024}{Lab tutor: interdisciplinary, computational, and statistical physics}{The University of Sydney}{}\vspace{-1em}
...
\entry{2026}{Maths in the Brain (Melbourne)}{Talk}
